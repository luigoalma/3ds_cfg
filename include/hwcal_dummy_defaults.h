...
static const HWCALRtcCompensationData_T DummyRtcComp = (HWCALRtcCompensationData_T){
	.CompensationValue = 0x80
};

static const HWCALScreenFlickerData_T DummyScreenFlicker = (HWCALScreenFlickerData_T){
	.FlickerTop = 0x5C,
	.FlickerBottom = 0x5F
};

static const HWCALOuterCamarasPart1Data_T DummyOuterCams1 = (HWCALOuterCamarasPart1Data_T){
	.Flags = 0,
...
static const HWCALTouchData_T DummyTouch = (HWCALTouchData_T){
	.RawX0 = 1638,
	.RawY0 = 1024,
	.PointX0 = 127,
	.PointY0 = 59,
...
static const HWCALCirclePadPart1Data_T DummyCirclePad1 = (HWCALCirclePadPart1Data_T){
	.CenterX = 0x800,
	.CenterY = 0x800,
	.Unk = {0}
};

static const HWCALCodecData_T DummyCodec = (HWCALCodecData_T){
	.DriverGainHP = 0,
	.DriverGainSP = 1,
	.AnalogVolumeHP = 0,
	.AnalogVolumeSP = 7,
...
static const HWCALAccelerometerData_T DummyAccelerometer = (HWCALAccelerometerData_T){
	.OffsetX = 0,
	.ScaleX = 0x400,
	.OffsetY = 0,
	.ScaleY = 0x400,
...
static const HWCALSound3DFilterData_T DummySound3DFilter = (HWCALSound3DFilterData_T){
	.SpecialFilter = {
	...
	.IIRSurroundFilter = {0x3A593C54, 0xFC99327F, 0x2706212A, 0x366CD81, 0xDEA0A283}
};

static const HWCALLcdPowerSaveData_T DummyLcdPowerSave = (HWCALLcdPowerSaveData_T){
...
static const HWCALLcdStereoscopicData_T DummyLcdStereoscopic = (HWCALLcdStereoscopicData_T){
...
static const HWCALBacklightPwmData_T DummyBacklight = (HWCALBacklightPwmData_T){
	.Coefficients = {
...
static const HWCALCirclePadPart2Data_T DummyCirclePad2 = (HWCALCirclePadPart2Data_T){
...
static const HWCALLcdModeDelayData_T DummyLcdModeDelay = (HWCALLcdModeDelayData_T){
	.To2D = 0xD,
	.To3D = 0
};

static const HWCALMicrophoneEchoCancellationData_T DummyMicEchoCancel = (HWCALMicrophoneEchoCancellationData_T){
	.Unknown = {0x0C, 0x06, 0x0C, 0x01, 0x0C, 0xA3, 0x00, 0x08}
};

static const HWCALPitData_T DummyPit = (HWCALPitData_T){
	.VisibleFactor = 0x4C2B,
	.IRFactor = 0x4C2B
};

static const HWCALQtmData_T DummyQtm = (HWCALQtmData_T){
